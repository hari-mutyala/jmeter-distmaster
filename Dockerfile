...
ENTRYPOINT sh ${JMETER_HOME}/bin/jmeter.sh -t ${JMETER_HOME}/bin/examples/${SCRIPT_NAME} -l ${JMETER_HOME}/bin/reports/${SCRIPT_NAME}_results.jtl -e -o ${JMETER_HOME}/bin/reports 	 	   
