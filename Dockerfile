...
ENTRYPOINT sh ${JMETER_HOME}/bin/jmeter.sh -n -X -Jclient.rmi.localport=7000 -R 192.168.2.11,192.168.2.12,192.168.2.13 -t ${JMETER_HOME}/bin/examples/${SCRIPT_NAME}  	 	   
